...
| #2     | Published graph baseline | 60.1       | **53.4**          | 64.1                 | **48.3**            | 56.5     |
...
TypeGraph overall ACC (58.4%) is statistically significant over the strongest published graph baseline (56.5%) at 95% confidence [CI: 57.2%, 59.5%]. Full eval: 2,009 queries, GPT-5.4-mini generation. Baselines from arXiv:2506.05690 Table 3 (GPT-4o-mini generation). See `benchmarks/` for methodology and reproduction.
