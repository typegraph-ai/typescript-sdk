 ...
 *   npx tsx --env-file=.env license-tldr-retrieval/core/run.ts --seed        # re-index
 *   npx tsx --env-file=.env license-tldr-retrieval/core/run.ts --validate    # smoke test
...
const config = getConfig('license-tldr-retrieval/core')
