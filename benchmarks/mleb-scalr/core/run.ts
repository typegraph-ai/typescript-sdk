 ...
 *   npx tsx --env-file=.env mleb-scalr/core/run.ts --seed        # re-index
 *   npx tsx --env-file=.env mleb-scalr/core/run.ts --validate    # smoke test
 *   npx tsx --env-file=.env mleb-scalr/core/run.ts --record      # save to history
 */
...
const config = getConfig('mleb-scalr/core')
